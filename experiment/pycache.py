...
globalCacheVerbose = 3                  # 0: print nothing. 1: Print info about hits or misses. 2: print filenames. 3: print hash steps
    ...
    def update(self, obj, level = 0):
        ...
        if isinstance(obj, types.BuiltinFunctionType):
            ...
            try:
                ...
                # catch the "ndarray is not C-contiguous" error; hash a contiguous copy insead.
                self.hashAlg.update(obj.copy())
...
def memoize(function):
    return memoize_general(function, True)
    


def memoize_no_func_body(function):
    return memoize_general(function, False)
    


def memoize_general(function, do_hash_function):
